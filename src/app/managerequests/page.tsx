...
//     if(session){
//         return(
//             <div className="md:mx-8 sm:mx-2 sm:mt-4 mb-8 flex flex-col items-center justify-center h-[100vh] rounded-md bg-[#323232] bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100 shadow-md ">
//                 <div className="border-none h-[50rem] lg:w-1/2 sm:w-full  rounded-lg bg-[#323232] flex flex-col">
//                     <h1 className="text-[#DDD0C8] text-[2rem] m-4 text-center h-1/6">Request Box</h1>
//                     <div className="border border-red-500 m-4 h-5/6 mt-[-4rem] overflow-scroll no-scrollbar">
//                         <RequestBarContainer/>
//                     </div>
//                 </div>
//             </div>
